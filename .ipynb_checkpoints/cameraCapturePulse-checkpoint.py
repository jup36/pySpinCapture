...
import PySpin, time, threading, queue, os, sys
...
SEC_TO_RECORD = 180 #approximate # seconds to record for; can also use Ctrl-C to interupt in middle of capture
...
frameRate = 500 # MUST MATCH WITH EXTERNAL PULSES # FOR FREE RUN: cam1.AcquisitionResultingFrameRate()
